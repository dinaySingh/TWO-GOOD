...
function videoconAnimation() {
    ...
    // here i add what happen when i enter in the video 
    ...
    // here i add what happen when i leave the video 
    ...
    // here i add what happen when i move the curser in video 

    videocon.addEventListener("mousemove", function (dets) {
        // The dets object captures the current mouse position.
        gsap.to(playbtn, {
            left: dets.x - 80,
            top: dets.y - 80,
        })
